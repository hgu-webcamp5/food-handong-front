...
function Dashboard() {
  ...
  const restaurant = ['샤브20', '장성동', '평일런치, 평일디너, 주말, 공휴일', '육류'];
  const score = [4.8, 3, 5];
  const review = ['언양닭칼국수', '맛있어요!', '4일전'];
  ...
  return (
    <Grid container spacing={10}>
                ...
                <Grid item xs={5}>
                  <CardContent sx={{ marginLeft: -9 }}>
                    ...
                    >
                      ...
                      {score[0]}
                      <FavoriteIcon
                        sx={{ color: '#ff6666', fontSize: 19, marginLeft: 1, marginBottom: -0.5 }}
                      />{' '}
                      {score[1]}
                      <ChatBubbleIcon
                        sx={{ color: '#33cccc', fontSize: 18, marginLeft: 1, marginBottom: -0.5 }}
                      />{' '}
                      {score[2]}
                    </Typography>
                  </CardContent>
              ...
              <Grid container>
                ...
                <Grid item xs={5}>
                  <CardContent sx={{ marginLeft: -9 }}>
                    ...
                    <Typography
                      variant="body2"
                      sx={{ mb: 1.5, marginTop: 1, fontSize: 13 }}
                      color="text.secondary"
                    >
                      {restaurant[2]}
                    </Typography>
                    <Typography
                      variant="body2"
                      sx={{ mb: 1.5, marginTop: 1, fontSize: 12 }}
                      color="text.secondary"
                    >
                      <StarIcon sx={{ color: '#ffcc33', fontSize: 18, marginBottom: -0.5 }} />{' '}
                      {score[0]}
                      <FavoriteIcon
                        sx={{ color: '#ff6666', fontSize: 17, marginLeft: 1, marginBottom: -0.5 }}
                      />{' '}
                      {score[1]}
                      <ChatBubbleIcon
                        sx={{ color: '#33cccc', fontSize: 16, marginLeft: 1, marginBottom: -0.5 }}
                      />{' '}
                      {score[2]}
                    </Typography>
                  </CardContent>
      ...
      {!more && !rev && (
        <Grid item xs={4} sx={{ marginLeft: -8, marginRight: -20 }}>
          <List
            sx={{
              width: '100%',
              maxWidth: 360,
                  ...
                  <Grid container>
                    ...
                    <Grid item xs={7}>
                      <CardContent sx={{ marginLeft: -6, marginTop: -1 }}>
                        ...
                        <Typography
                          variant="body2"
                          sx={{ mb: 1.5, marginTop: -0.5, fontSize: 12 }}
                          color="text.secondary"
                        >
                          <StarIcon sx={{ color: '#ffcc33', fontSize: 18, marginBottom: -0.5 }} />{' '}
                          {score[0]}
