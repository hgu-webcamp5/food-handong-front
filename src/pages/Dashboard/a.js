...
function Dashboard() {
  ...
  const [res, showRestaurant] = useState(false);
  const [rev, showReview] = useState(false);
  return (
    <Grid container spacing={10}>
      ...
      <Grid item xs={6}>
        ...
        <Link href="#" underline="none">
          {/* 더보기 X */}
          {res==false && <Card sx={{ width: 550 }} onMouseEnter={() => { setSize(false) }} onMouseLeave={() => { setSize(true) }}>
            <Grid container>
              <Grid item xs={5}>
              ...
              <Grid item xs={2}>
                ...
                <CardActions sx={{ marginTop: 5 }}>
                  <Button size="small" sx={{ marginLeft: 1.5 }} onClick={() => { showRestaurant(true); console.log("res: ",{res}); console.log("rev: ",{rev});}}>{!res ? "더보기 ⟩" : "접기 ⟨"}</Button>
                </CardActions>
              </Grid>
            </Grid>
          </Card>}
          {/* 더보기 O */}
          {res==true && <Card sx={{ width: 450 }} onMouseEnter={() => { setSize(false) }} onMouseLeave={() => { setSize(true) }}>
            <Grid container>
              <Grid item xs={5}>
                <CardContent sx={{ paddingRight: 0 }}>
                  <img
              ...
              <Grid item xs={2}>
                ...
                <CardActions sx={{ marginTop: 5 }}>
                  <Button size="small" onClick={() => { showRestaurant(false); console.log("res: ",{res}); console.log("rev: ",{rev}); }}> {!res ? "더보기 ⟩" : "접기 ⟨"}</Button>
                </CardActions>
              </Grid>
            </Grid>
          </Card>}
            ...
            <Card sx={{ width: 428 }}>
              <Grid container>
                ...
                <Grid item xs={2.5}>
                  ...
                  <br />
                  <CardActions>
                    <Button size="small" sx={{ marginLeft: 1 }} onClick={() => { showReview(true); console.log("res: ",{res}); console.log("rev: ",{rev});}}>{!rev ? "더보기 ⟩" : "접기 ⟨"} </Button>
                  </CardActions>
                </Grid>
              </Grid>
            </Card>
            ...
            <Card sx={{ width: 352 }}>
              <Grid container>
                ...
                <Grid item xs={3}>
                  ...
                  <CardActions>
                    <Button size="small" sx={{ marginLeft: 1 }} onClick={() => { showReview(false); console.log("res: ",{res}); console.log("rev: ",{rev});}}>{!rev ? "더보기 ⟩" : "접기 ⟨"}</Button>
                  </CardActions>
                </Grid>
              </Grid>
            </Card>
      ...
      {res==false && rev==true && <Grid item xs={4} sx={{ marginLeft: -8, marginRight: -20 }}>
        <List sx={{ width: '100%', maxWidth: 360, bgcolor: 'background.paper',textAlign: 'center', fontWeight: 'bold' }}>
          내가 쓴 리뷰
          `<Link href="#" underline="none">
            <ListItem alignItems="flex-start">
