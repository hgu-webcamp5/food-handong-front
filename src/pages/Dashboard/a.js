...
function Dashboard() {
  ...
  const [res, setRestaurant] = useState(false);
              ...
              <Grid container>
                ...
                <Grid item xs={2}>
                  ...
                  <CardActions sx={{ marginTop: 5 }}>
                    <Button size="small" sx={{ marginLeft: 1.5 }} onClick={() => { setRestaurant(true) }}>{!res ? "더보기 ⟩" : "접기 ⟨"}</Button>
                  </CardActions>
                </Grid>
              </Grid>
            </Card>}
            ...
            {(rev==true || res==true) && <Card sx={{ width: 450, ":hover": {transform: "scale(1.02)"} }} >
              <Grid container>
                ...
                <Grid item xs={2}>
                  ...
                  <CardActions sx={{ marginTop: 5 }}>
                    <Button size="small" onClick={() => { setRestaurant(false) }}>{!res ? "더보기 ⟩" : "접기 ⟨"}</Button>
                  </CardActions>
                </Grid>
              </Grid>
            </Card>}
              ...
              <Card sx={{ width: 428 }}>
                <Grid container>
                  ...
                  <Grid item xs={2.5}>
                    ...
                    <br />
                    <CardActions>
                      <Button size="small" sx={{ marginLeft: 1 }} onClick={() => { showReview(true); console.log(rev) }}>{!rev ? "더보기 ⟩" : "접기 ⟨"}</Button>
                    </CardActions>
                  </Grid>
                </Grid>
              </Card>
              ...
              <Card sx={{ width: 352 }}>
                <Grid container>
                  ...
                  <Grid item xs={3}>
                    ...
                    <CardActions>
                      <Button size="small" sx={{ marginLeft: 1 }} onClick={() => { showReview(false); console.log(rev);}}>{!rev ? "더보기 ⟩" : "접기 ⟨"}</Button>
                    </CardActions>
                  </Grid>
                </Grid>
              </Card>
